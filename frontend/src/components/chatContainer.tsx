...
const ChatContainer: React.FC = () => {
    const { messages, getMessages, isMessagesLoading, selectedUser, subscribeToMessages, unsubscribeFromMessages} = userChatService();
    ...
    if (!selectedUser) {
        return (
            <div className='flex-1 flex items-center justify-center'>
                <p className='text-lg text-gray-400'>Select a user to start chatting.</p>
            </div>
        );
    }
